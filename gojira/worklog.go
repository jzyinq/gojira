...
func Test() {
	...
	table.Select(0, 0).SetFixed(1, 1).SetDoneFunc(func(key tcell.Key) {
		...
		//test.SetRoot(newWorklogForm(test, flex, table.GetCell(row, column).Text), true)
	})
...
//func newWorklogForm(app *tview.Application, flex *tview.Frame, workLog string) *tview.Form {
//	form := tview.NewForm().
